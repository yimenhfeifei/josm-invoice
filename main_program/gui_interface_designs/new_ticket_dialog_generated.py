...
#
# Created: Mon Jul 18 21:41:13 2011
...
class Ui_newTicketDialog(object):
    def setupUi(self, newTicketDialog):
        ...
        self.widget.setGeometry(QtCore.QRect(11, 10, 384, 491))
        ...
        self.payloadTableWidget = QtGui.QTableWidget(self.widget)
        ...
        self.payloadTableWidget.setMinimumSize(QtCore.QSize(351, 301))
        self.payloadTableWidget.setMaximumSize(QtCore.QSize(78799, 787787))
        self.payloadTableWidget.setStyleSheet(_fromUtf8(""))
        ...
        self.payloadTableWidget.setSelectionMode(QtGui.QAbstractItemView.NoSelection)
        ...
        self.payloadTableWidget.setItem(0, 0, item)
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.NoBrush)
        brush = QtGui.QBrush(QtGui.QColor(255, 0, 0))
        brush.setStyle(QtCore.Qt.NoBrush)
        ...
        item.setBackground(brush)
        item.setForeground(brush)
        self.payloadTableWidget.setItem(0, 1, item)
        ...
        self.gridLayout_2.addWidget(self.totalValueLabel, 5, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.totalValueLineEdit, 5, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.reviewTicketButton, 6, 3, 1, 2)
    ...
    def retranslateUi(self, newTicketDialog):
        ...
        __sortingEnabled = self.payloadTableWidget.isSortingEnabled()
        self.payloadTableWidget.setSortingEnabled(False)
        self.payloadTableWidget.setSortingEnabled(__sortingEnabled)
