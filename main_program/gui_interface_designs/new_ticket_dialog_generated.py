...
#
# Created: Wed Sep 14 11:26:47 2011
...
class Ui_newTicketDialog(object):
    def setupUi(self, newTicketDialog):
        ...
        self.firstNameLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "name", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lastNameLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "name", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.houseNumberLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "houseNumber", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.streetLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "street", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.townLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "town", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.postcodeLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "postcode", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.vehicleRegistrationLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "post2001Reg", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label = QtGui.QLabel(self.payloadTab)
        ...
        self.grossWeightLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "weight", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_2 = QtGui.QLabel(self.payloadTab)
        ...
        self.tareWeightLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "weight", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_3 = QtGui.QLabel(self.payloadTab)
        ...
        self.netWeightLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "weight", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.materialCombobox = MaterialCombobox(self.payloadTab)
        ...
        self.payloadValueLineEdit.setProperty("regexString", QtGui.QApplication.translate("newTicketDialog", "value", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.payloadTableWidget = PayloadTableWidget(self.payloadTab)
        self.payloadTableWidget.setMinimumSize(QtCore.QSize(411, 311))
        self.payloadTableWidget.setMaximumSize(QtCore.QSize(411, 311))
...
"Click the red \'Delete\' to remove.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.totalValueLineEdit = TotalValueLineEdit(self.payloadTab)
