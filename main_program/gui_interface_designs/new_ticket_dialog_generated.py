...
#
# Created: Thu Jun  2 11:18:02 2011
...
class Ui_newTicketDialog(object):
    def setupUi(self, newTicketDialog):
        ...
        self.vehicleRegistrationLabel = QtGui.QLabel(self.widget)
        self.vehicleRegistrationLabel.setObjectName(_fromUtf8("vehicleRegistrationLabel"))
        self.gridLayout.addWidget(self.vehicleRegistrationLabel, 6, 0, 1, 2)
        self.vehicleRegistrationLineEdit = QtGui.QLineEdit(self.widget)
        ...
        self.gridLayout.addWidget(self.vehicleRegistrationLineEdit, 6, 2, 1, 1)
